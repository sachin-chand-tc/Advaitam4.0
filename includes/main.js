function openNav() {
	...
	$(document).ready(function (){
		...
		$('a.in').on("click",function (){
            ...
            $(".contact-container-special").scroll(function(){
                var nth = Math.floor($(this).scrollTop()/256)+1;
                if(!$(".content-displayed > section > .departments > ul > li:nth-of-type("+nth+")").hasClass("active")){
                    $(".content-displayed > section > .departments > ul > li.active").removeClass("active");
                    $(".content-displayed > section > .departments > ul > li:nth-of-type("+nth+")").addClass("active");
                }   
            });
		});
