...
function shatter() {
    ...
    for (var i = 0; i < indices.length; i += 3) {
		...
		newZ = fragment.canvas.style.zIndex;
		newRx = fragment.canvas.style.rotationX;
		newRy = fragment.canvas.style.rotationY;
		
		fragment.canvas.zIndex = -500;
		fragment.canvas.rotationX = rx;
		fragment.canvas.rotationY = ry;
		fragment.canvas.style.alpha = 0;
        ...
        tl1.from(fragment.canvas, 0.6,{alpha:0}, 0.4);
